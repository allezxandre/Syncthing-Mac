...
This is a Mac OS GUI for [Syncthing](https://syncthing.net) (an open-source, P2P, file sync sofwtare on [GitHub](https://github.com/syncthing/syncthing)), made in Swift. 
